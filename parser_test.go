...
var (
	samples map[string]string = map[string]string{
		...
		"jan 15 14:07:35 testserver passwd: pam_unix(passwd:chauthtok): password changed for ustream":                                                                                                                                                                                      "%createtime% %apphost% %appname% : %method% ( %string% : %action% ) : password changed for %dstuser%",
		"jan 14 10:15:56 testserver sudo:    gonner : tty=pts/3 ; pwd=/home/gonner ; user=root ; command=/bin/su - ustream":                                                                                                                                                                "%createtime% %apphost% %appname% : %srcuser% : tty = %string% ; pwd = %string% ; user = %dstuser% ; command = %method-10%",
